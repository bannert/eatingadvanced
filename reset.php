...
//Abfrage des Nutzers
$statement = $pdo->prepare("SELECT * FROM benutzer WHERE B_ID = :userid");
...
if(isset($_GET['send'])) {
 ...
 $statement = $pdo->prepare("UPDATE benutzer SET Password = :passworthash, passwortcode = NULL, passwortcode_time = NULL WHERE B_ID = :userid");
